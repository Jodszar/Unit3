...
public class RightTriangle {
    ...
    public static void main(String [] args){
        ...
        if(isRight(a,b,c)==true)
            ...
            System.out.println("The side length of " +a+", "+b+", and "+c+" from a triangle, but it is not a right triangle");
        else
            System.out.println("The side length of "+a+", "+b+", and " +c+" do not form a triangle ");
    }
}
